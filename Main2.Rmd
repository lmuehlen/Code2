...
UVGD= GDP current prices (Mrd ECU/EUR)
AVGDGP= output gap (Percentage of potential gross domestic product at constant prices)
...
reg_full_ratio<-lpdid(data, window = c(-5,7),
             y="ratio_inv_exp",
             exp_var = "frsi_national_full",
            controls = c("control_UVGD","control_UBLGI","control_UYIG","control_legelec","control_exelec"),
...
reg_full_exp<-lpdid(data, window = c(-5,6),
             y="log_exp",
             exp_var = "frsi_national_full",
              controls = c("control_UVGD","control_UBLGI","control_UYIG","control_legelec","control_exelec"),
             unit_index = "countrycode",
...
reg_full_inv<-lpdid(data, window = c(-5,6),
             y="log_inv",
             exp_var = "frsi_national_full",
             controls = c("control_UVGD","control_UBLGI","control_UYIG","control_legelec","control_exelec"),
             unit_index = "countrycode",
...
reg_bbr_ratio<-lpdid(data, window = c(-5,7),
             y="ratio_inv_exp",
...
reg_bbr_exp<-lpdid(data, window = c(-5,7),
             y="log_exp",
             exp_var = "frsi_national_bbr",
              controls = c("control_UVGD","control_UBLGI","control_UYIG","control_legelec","control_exelec"),
             unit_index = "countrycode",
...
reg_bbr_inv<-lpdid(data, window = c(-5,7),
             y="log_inv",
             exp_var = "frsi_national_bbr",
             controls = c("control_UVGD","control_UBLGI","control_UYIG","control_legelec","control_exelec"),
             unit_index = "countrycode",
...
reg_dr_ratio<-lpdid(data, window = c(-5,7),
             y="ratio_inv_exp",
...
reg_dr_exp<-lpdid(data, window = c(-5,7),
             y="log_exp",
             exp_var = "frsi_national_dr",
              controls = c("control_UVGD","control_UBLGI","control_UYIG","control_legelec","control_exelec"),
             unit_index = "countrycode",
...
reg_dr_inv<-lpdid(data, window = c(-5,7),
             y="log_inv",
             exp_var = "frsi_national_dr",
             controls = c("control_UVGD","control_UBLGI","control_UYIG","control_legelec","control_exelec"),
             unit_index = "countrycode",
...
reg_er_ratio<-lpdid(data, window = c(-5,7),
             y="ratio_inv_exp",
...
reg_er_exp<-lpdid(data, window = c(-5,7),
             y="log_exp",
             exp_var = "frsi_national_er",
              controls = c("control_UVGD","control_UBLGI","control_UYIG","control_legelec","control_exelec"),
             unit_index = "countrycode",
...
reg_er_inv<-lpdid(data, window = c(-5,7),
             y="log_inv",
             exp_var = "frsi_national_er",
             controls = c("control_UVGD","control_UBLGI","control_UYIG","control_legelec","control_exelec"),
             unit_index = "countrycode",
